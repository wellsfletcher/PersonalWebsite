...
(function($) {
    ...
    $main._show = function(id, initial) {
        ...
        if ($article.length == 0) {
            // $article = $main_articles.filter('#' + "projects");
			/*
			setTimeout(function() {
				$article.scrollTop($("#wfs-game").offset().top);
			}, (initial ? 1000 : 0));
			*/
            return;
		}
    ...
    function AddVideoAttributes($frame) {
        ...
        // new!
        var $iframeVideo = $frame.contents().find("video");
            ...
            if (isImage) {
                ...
                tempImg.onload = function() {
                    ...
                    */
                    ...
                    var iframeWidth = getCappedElementWidth(imageWidth, imageHeight, maxWidth, maxHeight);
                ...
                var iframeWidth = getCappedElementWidth(targetWidth, targetHeight, maxWidth, maxHeight);
                var iframeHeight = getCappedElementHeight(targetWidth, targetHeight, maxWidth, maxHeight);
